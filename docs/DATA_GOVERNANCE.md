...
| JW-SSD 官方完整包 | `OFFICIAL_SOURCE` | 组委会提供的官方数据 | 训练/验证候选来源、字段和多模态开发 | 与冻结评测集混用或直接作为耀斑标签 | 按组委会数据使用条款处理 |
| JW-SSD 20260826 官方五分类四模态评测集 | `OFFICIAL_EVALUATION_SET` | `SHRGT45_官方五分类四模态扩展样本_20260826.zip`；SHA256=`db07a1a05336597d3cba3717605057caa45b80f7365c3963ea9d662e6dda40d4` | 只用于最终离线评测和质量审计 | 训练、调参、阈值/模型选择、生成 M+ 标签 | 按组委会数据使用条款处理 |
